...
Name : 3.b. GU Extract conditioning factors values
...
class BGuExtractConditioningFactorsValues(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterVectorLayer('testingzones10', 'Testing zones 1 0 GU', types=[QgsProcessing.TypeVectorPolygon], defaultValue=None))
        self.addParameter(QgsProcessingParameterVectorLayer('trainingzones10', 'Training zones 1 0 GU', types=[QgsProcessing.TypeVectorPolygon], defaultValue=None))
    ...
    def name(self):
        return '3.b. GU Extract conditioning factors values'
    ...
    def createInstance(self):
        return BGuExtractConditioningFactorsValues()
